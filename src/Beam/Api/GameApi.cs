...
namespace Beam.Api
{
    ...
    public interface IGameApiSync : IApiAccessor
    {
        ...
        GenerateLinkCodeResponse GenerateLinkCode(GenerateLinkCodeRequestInput generateLinkCodeRequestInput, int operationIndex = 0);
        ...
        ApiResponse<GenerateLinkCodeResponse> GenerateLinkCodeWithHttpInfo(GenerateLinkCodeRequestInput generateLinkCodeRequestInput, int operationIndex = 0);
        /// <summary>
    ...
    public interface IGameApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<GenerateLinkCodeResponse> GenerateLinkCodeAsync(GenerateLinkCodeRequestInput generateLinkCodeRequestInput, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<GenerateLinkCodeResponse>> GenerateLinkCodeWithHttpInfoAsync(GenerateLinkCodeRequestInput generateLinkCodeRequestInput, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Get information about your game
        /// </summary>
        /// <remarks>
    ...
    public partial class GameApi : IGameApi
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>GenerateLinkCodeResponse</returns>
        public GenerateLinkCodeResponse GenerateLinkCode(GenerateLinkCodeRequestInput generateLinkCodeRequestInput, int operationIndex = 0)
        {
            Beam.Client.ApiResponse<GenerateLinkCodeResponse> localVarResponse = GenerateLinkCodeWithHttpInfo(generateLinkCodeRequestInput);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of GenerateLinkCodeResponse</returns>
        public Beam.Client.ApiResponse<GenerateLinkCodeResponse> GenerateLinkCodeWithHttpInfo(GenerateLinkCodeRequestInput generateLinkCodeRequestInput, int operationIndex = 0)
        {
            // verify the required parameter 'generateLinkCodeRequestInput' is set
            if (generateLinkCodeRequestInput == null)
            {
                throw new Beam.Client.ApiException(400, "Missing required parameter 'generateLinkCodeRequestInput' when calling GameApi->GenerateLinkCode");
            }
            ...
            localVarRequestOptions.Operation = "GameApi.GenerateLinkCode";
            ...
            {
                Exception _exception = this.ExceptionFactory("GenerateLinkCode", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of GenerateLinkCodeResponse</returns>
        public async System.Threading.Tasks.Task<GenerateLinkCodeResponse> GenerateLinkCodeAsync(GenerateLinkCodeRequestInput generateLinkCodeRequestInput, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Beam.Client.ApiResponse<GenerateLinkCodeResponse> localVarResponse = await GenerateLinkCodeWithHttpInfoAsync(generateLinkCodeRequestInput, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (GenerateLinkCodeResponse)</returns>
        public async System.Threading.Tasks.Task<Beam.Client.ApiResponse<GenerateLinkCodeResponse>> GenerateLinkCodeWithHttpInfoAsync(GenerateLinkCodeRequestInput generateLinkCodeRequestInput, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'generateLinkCodeRequestInput' is set
            if (generateLinkCodeRequestInput == null)
            {
