...
namespace Beam.Model
{
    ...
    public partial class GetProfileResponse : IEquatable<GetProfileResponse>, IValidatableObject
    {
        ...
        public GetProfileResponse(string id = default(string), string gameId = default(string), string externalId = default(string), string userId = default(string), List<CreateProfileResponseWalletsInner> wallets = default(List<CreateProfileResponseWalletsInner>))
        {
