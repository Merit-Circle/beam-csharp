...
namespace Beam.Model
{
    ...
    public partial class GetAccountResponse : IEquatable<GetAccountResponse>, IValidatableObject
    {
        ...
        public GetAccountResponse(string id = default(string), string playerId = default(string), string address = default(string), int chainId = default(int), bool custodial = default(bool))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for GetAccountResponse and cannot be null");
            }
            this.Id = id;
            // to ensure "playerId" is required (not null)
            if (playerId == null)
            {
                throw new ArgumentNullException("playerId is a required property for GetAccountResponse and cannot be null");
            }
            this.PlayerId = playerId;
            // to ensure "address" is required (not null)
            if (address == null)
            {
                throw new ArgumentNullException("address is a required property for GetAccountResponse and cannot be null");
            }
