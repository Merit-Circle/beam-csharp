...
namespace Beam.Model
{
    ...
    public partial class CreateProfileResponse : IEquatable<CreateProfileResponse>, IValidatableObject
    {
        ...
        public CreateProfileResponse(string id = default(string), string gameId = default(string), string externalId = default(string), string userId = default(string), List<CreateProfileResponseWalletsInner> wallets = default(List<CreateProfileResponseWalletsInner>))
        {
