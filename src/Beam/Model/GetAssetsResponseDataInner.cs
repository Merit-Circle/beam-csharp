...
namespace Beam.Model
{
    ...
    public partial class GetAssetsResponseDataInner : IEquatable<GetAssetsResponseDataInner>, IValidatableObject
    {
        ...
        public GetAssetsResponseDataInner(string id = default(string), string name = default(string), string imageUrl = default(string), string assetType = default(string), string assetAddress = default(string), decimal quantity = default(decimal))
        {
