...
{
    /// <summary>
    /// GetTransactionsResponseDataInnerPolicyTransactionIntentsInnerPlayerAccountsInner
    /// </summary>
    [DataContract(Name = "GetTransactionsResponse_data_inner_policy_transactionIntents_inner_player_accounts_inner")]
    public partial class GetTransactionsResponseDataInnerPolicyTransactionIntentsInnerPlayerAccountsInner : IEquatable<GetTransactionsResponseDataInnerPolicyTransactionIntentsInnerPlayerAccountsInner>, IValidatableObject
    {
        /// <summary>
        /// Defines VarObject
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetTransactionsResponseDataInnerPolicyTransactionIntentsInnerPlayerAccountsInner" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetTransactionsResponseDataInnerPolicyTransactionIntentsInnerPlayerAccountsInner() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetTransactionsResponseDataInnerPolicyTransactionIntentsInnerPlayerAccountsInner" /> class.
        /// </summary>
        ...
        public GetTransactionsResponseDataInnerPolicyTransactionIntentsInnerPlayerAccountsInner(List<Object> transactionIntents = default(List<Object>), string id = default(string), ObjectEnum varObject = default(ObjectEnum), decimal createdAt = default(decimal), string address = default(string), string ownerAddress = default(string), bool deployed = default(bool), bool custodial = default(bool), decimal chainId = default(decimal), string accountType = default(string), string pendingOwnerAddress = default(string))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for GetTransactionsResponseDataInnerPolicyTransactionIntentsInnerPlayerAccountsInner and cannot be null");
            }
            this.Id = id;
            ...
            if (address == null)
            {
                throw new ArgumentNullException("address is a required property for GetTransactionsResponseDataInnerPolicyTransactionIntentsInnerPlayerAccountsInner and cannot be null");
            }
            this.Address = address;
            // to ensure "ownerAddress" is required (not null)
            if (ownerAddress == null)
            {
                throw new ArgumentNullException("ownerAddress is a required property for GetTransactionsResponseDataInnerPolicyTransactionIntentsInnerPlayerAccountsInner and cannot be null");
            }
            ...
            if (accountType == null)
            {
                throw new ArgumentNullException("accountType is a required property for GetTransactionsResponseDataInnerPolicyTransactionIntentsInnerPlayerAccountsInner and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetTransactionsResponseDataInnerPolicyTransactionIntentsInnerPlayerAccountsInner {\n");
        ...
        {
            return this.Equals(input as GetTransactionsResponseDataInnerPolicyTransactionIntentsInnerPlayerAccountsInner);
        }

        /// <summary>
        /// Returns true if GetTransactionsResponseDataInnerPolicyTransactionIntentsInnerPlayerAccountsInner instances are equal
        /// </summary>
        /// <param name="input">Instance of GetTransactionsResponseDataInnerPolicyTransactionIntentsInnerPlayerAccountsInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetTransactionsResponseDataInnerPolicyTransactionIntentsInnerPlayerAccountsInner input)
        {
            if (input == null)
            {
                return false;
