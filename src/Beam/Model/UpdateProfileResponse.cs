...
namespace Beam.Model
{
    ...
    public partial class UpdateProfileResponse : IEquatable<UpdateProfileResponse>, IValidatableObject
    {
        ...
        public UpdateProfileResponse(string id = default(string), string gameId = default(string), string externalId = default(string), string userId = default(string), Object userConnectionCreatedAt = default(Object), List<CreateProfileResponseWalletsInner> wallets = default(List<CreateProfileResponseWalletsInner>))
        {
