...
namespace Beam.Model
{
    ...
    public partial class Check503Response : IEquatable<Check503Response>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as Check503Response);
        }

        /// <summary>
        /// Returns true if Check503Response instances are equal
        /// </summary>
        /// <param name="input">Instance of Check503Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Check503Response input)
        {
            if (input == null)
            {
                return false;
