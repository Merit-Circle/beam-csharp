...
namespace Beam.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreateTransactionResponse_policy_strategy")]
    public partial class CreateTransactionResponsePolicyStrategy : IEquatable<CreateTransactionResponsePolicyStrategy>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateTransactionResponsePolicyStrategy" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateTransactionResponsePolicyStrategy() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateTransactionResponsePolicyStrategy" /> class.
        /// </summary>
        ...
        public CreateTransactionResponsePolicyStrategy(SponsorSchemaEnum sponsorSchema = default(SponsorSchemaEnum), string tokenContract = default(string), string tokenContractAmount = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateTransactionResponsePolicyStrategy {\n");
        ...
        {
            return this.Equals(input as CreateTransactionResponsePolicyStrategy);
        }

        /// <summary>
        /// Returns true if CreateTransactionResponsePolicyStrategy instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateTransactionResponsePolicyStrategy to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateTransactionResponsePolicyStrategy input)
        {
            if (input == null)
            {
                return false;
